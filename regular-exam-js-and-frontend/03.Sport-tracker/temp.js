...
function init() {
    ...
    function createEntry({ workout, location, date, _id }) {
        const entryEl = createElement('div', { className: 'list', dataset: { workout, location, date, _id }}, listEntriesEl);
        ...
        const buttonsEl = createElement('div', { className: 'list' }, entryEl);
        createElement('button', { textContent: 'Change', className: 'change-btn', onclick: changeHandler }, buttonsEl);
        createElement('button', { textContent: 'Done', className: 'done-btn', onclick: deleteHandler }, buttonsEl);
    }
